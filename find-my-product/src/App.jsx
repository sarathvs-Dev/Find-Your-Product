    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="text-center mb-8 md:mb-12 animate-fadeIn">
          <div className="inline-flex items-center justify-center mb-4 p-3 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-full shadow-lg">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-700">
            shelf<span className="text-yellow-500 animate-pulse">Sense</span>
          </h1>
        ...
        {(!storeData || searchMode === 'product') && (
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-3xl mx-auto mb-8 transition-all duration-300 hover:shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-indigo-200 rounded-lg text-indigo-700 hover:from-blue-100 hover:to-indigo-100 transition-all shadow-sm"
              >
              ...
              <div>
                <form onSubmit={handleProductSearch} className="mb-6">
                  <div className="relative mb-3">
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition shadow-sm hover:shadow-md"
                    />
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <select
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition shadow-sm"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition flex items-center justify-center"
                    >
                ...
                {productSearchResults.length > 0 ? (
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {productSearchResults.map((product, index) => (
                        <div key={index} className="p-4 border rounded-lg bg-white shadow-sm hover:shadow-md transition-all duration-300 group">
                          <div className="flex justify-between items-start">
                            <div>
                              <h4 className="font-bold text-lg text-gray-800 group-hover:text-indigo-600 transition-colors">{product.name}</h4>
                          ...
                          <button 
                            ...
                            className="mt-3 text-sm text-indigo-600 hover:text-indigo-800 flex items-center group-hover:underline"
                          >
                  ...
                  <div className="text-center py-8">
                    <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-full mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <h4 className="mt-2 text-lg font-medium text-gray-700">No products found</h4>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h4 className="mt-2 text-lg font-medium text-gray-700">Search for products</h4>
                    <p className="mt-1 text-gray-500">Enter a product name or select a category to find which stores carry it</p>
                  </div>
                )}
              </div>
            ) : (
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-6 mb-6 text-white">
                    ...
                    <p className="text-blue-100 mb-4">Point your camera at the store's QR code to locate products</p>
                    <div className="mb-6">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <form onSubmit={handleInputSearch} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full py-3 px-4 rounded-lg font-medium text-white transition-all ${isLoading ? 'bg-indigo-400' : 'bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700'} shadow-md hover:shadow-lg flex items-center justify-center`}
                      >
                        {isLoading ? (
                          <>
                    ...
                    {error && (
                      <div className="mt-4 p-3 bg-red-50 text-red-700 rounded-lg flex items-start border border-red-100">
        ...
        {storeData && searchMode === 'store' && (
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-6xl mx-auto animate-fadeIn">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8">
              <div className="mb-4 md:mb-0">
                <div className="flex items-center">
                  <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-2 rounded-lg mr-4 shadow-md">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                  <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-1">{storeData.name}</h2>
                    <p className="text-gray-600">Store ID: <span className="font-mono bg-blue-50 px-2 py-1 rounded text-blue-700">{scannedId}</span></p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-3 w-full md:w-auto">
                <button
                  onClick={toggleSearchMode}
                  className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-indigo-200 rounded-lg text-indigo-700 hover:from-blue-100 hover:to-indigo-100 transition-all shadow-sm flex-1 md:flex-none justify-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                ...
                <button
                  ...
                  className="flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition shadow-sm flex-1 md:flex-none justify-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
              ...
              {filteredProducts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredProducts.map((p, i) => (
                    <div
                      key={i}
                      className="p-5 border rounded-xl shadow-sm hover:shadow-md transition-all duration-300 bg-white group relative overflow-hidden"
                    >
                      <div className="absolute top-0 right-0 bg-indigo-600 text-white text-xs font-bold px-2 py-1 rounded-bl-lg">
                        #{i+1}
                      </div>
                      <h3 className="text-lg font-bold text-gray-800 group-hover:text-indigo-600 transition-colors mb-2 pr-6">{p.name}</h3>
